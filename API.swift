...
public struct CreateMapInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, name: String, storageKey: String) {
    graphQLMap = ["id": id, "name": name, "storageKey": storageKey]
  }
  ...
  public var storageKey: String {
    get {
      return graphQLMap["storageKey"] as! String
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "storageKey")
    }
  }
}
...
public struct ModelMapConditionInput: GraphQLMapConvertible {
  ...
  public init(name: ModelStringInput? = nil, storageKey: ModelStringInput? = nil, and: [ModelMapConditionInput?]? = nil, or: [ModelMapConditionInput?]? = nil, not: ModelMapConditionInput? = nil) {
    graphQLMap = ["name": name, "storageKey": storageKey, "and": and, "or": or, "not": not]
  }
  ...
  public var storageKey: ModelStringInput? {
    get {
      return graphQLMap["storageKey"] as! ModelStringInput?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "storageKey")
    }
...
public struct UpdateMapInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, name: String? = nil, storageKey: String? = nil) {
    graphQLMap = ["id": id, "name": name, "storageKey": storageKey]
  }
...
public struct ModelMapFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, name: ModelStringInput? = nil, storageKey: ModelStringInput? = nil, and: [ModelMapFilterInput?]? = nil, or: [ModelMapFilterInput?]? = nil, not: ModelMapFilterInput? = nil) {
    graphQLMap = ["id": id, "name": name, "storageKey": storageKey, "and": and, "or": or, "not": not]
  }
...
public struct ModelSubscriptionMapFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelSubscriptionIDInput? = nil, name: ModelSubscriptionStringInput? = nil, storageKey: ModelSubscriptionStringInput? = nil, and: [ModelSubscriptionMapFilterInput?]? = nil, or: [ModelSubscriptionMapFilterInput?]? = nil) {
    graphQLMap = ["id": id, "name": name, "storageKey": storageKey, "and": and, "or": or]
  }
  ...
  public var storageKey: ModelSubscriptionStringInput? {
    get {
      return graphQLMap["storageKey"] as! ModelSubscriptionStringInput?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "storageKey")
    }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateTrailReport: GraphQLSelectionSet {
      ...
      public struct Map: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, name: String, storageKey: String, createdAt: String, updatedAt: String) {
          self.init(snapshot: ["__typename": "Map", "id": id, "name": name, "storageKey": storageKey, "createdAt": createdAt, "updatedAt": updatedAt])
        }
        ...
        public var storageKey: String {
          get {
            return snapshot["storageKey"]! as! String
          }
          set {
            snapshot.updateValue(newValue, forKey: "storageKey")
          }
        }
...
public final class CreateMapMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateMap: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String, storageKey: String, trailReports: TrailReport? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Map", "id": id, "name": name, "storageKey": storageKey, "trailReports": trailReports.flatMap { $0.snapshot }, "createdAt": createdAt, "updatedAt": updatedAt])
      }
