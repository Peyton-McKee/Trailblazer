...
//23
        Trail(name: "Dream Maker Terrain Park", difficulty: "Intermediate", annotations: [createAnnotation(title: "Dream Maker Terrain Park", latitude: 44.471098472385926, longitude: -70.87821486957192, difficulty: .intermediate), createAnnotation(title: "botDMTP", latitude: 44.47093461371656, longitude: -70.87731104843927, difficulty: .easy)]),
//24
...
//3D
    ...
    static let keyAnnotations = [botSpruce, botQLT, botNP, botChondola, auroraSideJD, jordanSideJD, botAurora, botJord, topLol, topExcal, topRogue, topKans, junctionWoodsman, topCyclone, northernLightsJunctionCyclone, kansasNLJunction, witchWayTop, cycloneJunctionAirglow, topBlackHole, topFirestar, startLO, topBorealis, kansasJunctionVortex, topParadigm, startSM, SMJunctionGR, topQuantum, topGR, topLD, topDM, Bend2DM, topT72, topSensation, topDMTP, topEscapade, top3D]
